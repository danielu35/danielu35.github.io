...
fetch(requestURL)
    ...
    .then(function(jsonObject) {
        ...
        pImg.setAttribute('src', 'images/' + towns[4].photo);
        pImg.setAttribute('class', 'pImg');

        pTitle.textContent = towns[4].name;
        pMoto.textContent = towns[4].motto;
        pYear.textContent = 'Year Founded: ' + towns[4].yearFounded;
        pPop.textContent = 'Population: ' + towns[4].currentPopulation;
        pRain.textContent = 'Annual Rain Fall: ' + towns[4].averageRainfall;
        ...
        fImg.setAttribute('src', 'images/' + towns[0].photo);
        fImg.setAttribute('class', 'fImg');

        fTile.textContent = towns[0].name;
        fMoto.textContent = towns[2].motto;
        fYear.textContent = 'Year Founded: ' + towns[0].yearFounded;
        fPop.textContent = 'Population' + towns[0].currentPopulation;
        fRain.textContent = 'Annual Rain Fall: ' + towns[0].averageRainfall;
        ...
        sImg.setAttribute('src', 'images/' + towns[5].photo);
        sImg.setAttribute('class', 'sImg');

        sTile.textContent = towns[5].name;
        sMoto.textContent = towns[5].motto;
        sYear.textContent = 'Year Founded: ' + towns[5].yearFounded;
        sPop.textContent = 'Population' + towns[5].currentPopulation;
        sRain.textContent = 'Annual Rain Fall: ' + towns[5].averageRainfall;
